    ...
    const template = `
                ...
                <div class="form-group img-formgroup">
                    ...
                    <div class="img-section">
                        ...
                        <input class="img-input" type="file" data-val="true" data-val-required="The image is required" id="ProductDetails_${newNum}__Images" name="ProductDetails[${newNum}].Images">
                    </div>
